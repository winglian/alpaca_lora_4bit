...
if not ft_config.skip:
    ...
    elif ft_config.ds_type == "leetcode" and not ft_config.skip:
        #### GPT4All Data
        data = train_data.TrainLeetcode(ft_config.dataset, ft_config.val_set_size, tokenizer, ft_config.cutoff_len)
    else:
